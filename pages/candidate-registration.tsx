  ...
  return (
    <>
      <Grid sx={{ justifyContent: 'space-around', paddingTop: 8 }} container>
        ...
        <Grid item mx={6}>
          <StyledList>
            ...
            <StyledListItem>
              <ListItemText>후보 등록 전에 확인하세요!</ListItemText>
            </StyledListItem>
            <StyledListItem>
              <ListItemText>등록 후에는 변경할 수 없습니다.</ListItemText>
            </StyledListItem>
          </StyledList>
        </Grid>
        <Grid item mx={6}>
      ...
      <Backdrop
        ...
        open={isCandidateRegistrationLoading}
      >
